...
### boss道具  教官武器 重型练习剑
 ["heavy_practice_sword","Heavy Practice Sword", [("heavy_practicesword",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_greatsword,
    21, weight(6.25)|spd_rtng(94)|weapon_length(128)|swing_damage(50,blunt)|thrust_damage(50,blunt),imodbits_none],
### boss item
 ...
 90 , weight(2.5)|spd_rtng(96) | weapon_length(150)|swing_damage(50 , blunt) | thrust_damage(50 ,  blunt),imodbits_polearm ],
### minion item
...
# Tutorial Items
 ...
 ["tutorial_sword_2", "Sword", [("long_sword",0),("scab_longsw_a", ixmesh_carry)], itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 0 , weight(1.5)|difficulty(0)|spd_rtng(100) | weapon_length(102)|swing_damage(18 , cut) | thrust_damage(15 ,  pierce),imodbits_sword ],
 ["tutorial_axe_2", "Axe", [("iron_ax",0)], itp_type_two_handed_wpn| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 0 , weight(4)|difficulty(0)|spd_rtng(91) | weapon_length(108)|swing_damage(19 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
 ["tutorial_spear_2", "Spear", [("spear",0)], itp_type_polearm| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear, 0 , weight(4.5)|difficulty(0)|spd_rtng(80) | weapon_length(158)|swing_damage(0 , cut) | thrust_damage(19 ,  pierce),imodbits_polearm ],
 ["tutorial_club_2", "Club", [("club",0)], itp_type_one_handed_wpn| itp_primary|itp_wooden_parry|itp_wooden_attack, itc_scimitar, 0 , weight(2.5)|difficulty(0)|spd_rtng(95) | weapon_length(95)|swing_damage(11 , blunt) | thrust_damage(0 ,  pierce),imodbits_none ],
 ["tutorial_battle_axe_2", "Battle Axe", [("battle_ax",0)], itp_type_two_handed_wpn| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 0 , weight(5)|difficulty(0)|spd_rtng(88) | weapon_length(108)|swing_damage(27 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
 ["tutorial_arrows_2","Arrows", [("arrow",0),("flying_missile",ixmesh_flying_ammo),("quiver", ixmesh_carry)], itp_type_arrows, itcf_carry_quiver_back, 0,weight(3)|abundance(160)|weapon_length(95)|thrust_damage(0,pierce)|max_ammo(20),imodbits_missile],
 ["tutorial_bolts_2","Bolts", [("bolt",0),("flying_missile",ixmesh_flying_ammo),("bolt_bag", ixmesh_carry),("bolt_bag_b", ixmesh_carry|imodbit_large_bag)], itp_type_bolts, itcf_carry_quiver_right_vertical, 0,weight(2.25)|abundance(90)|weapon_length(63)|thrust_damage(0,pierce)|max_ammo(18),imodbits_missile],
 ["tutorial_short_bow_2", "Short Bow", [("short_bow",0),("short_bow_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back, 0 , weight(1)|difficulty(0)|spd_rtng(98) | shoot_speed(49) | thrust_damage(12 ,  pierce  ),imodbits_bow ],
 ["tutorial_crossbow_2", "Crossbow", [("crossbow_a",0)], itp_type_crossbow |itp_primary|itp_two_handed|itp_cant_reload_on_horseback ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 0 , weight(3)|difficulty(0)|spd_rtng(42)|  shoot_speed(68) | thrust_damage(32,pierce)|max_ammo(1),imodbits_crossbow ],
 ["tutorial_throwing_daggers_2", "Throwing Daggers", [("throwing_dagger",0)], itp_type_thrown |itp_primary ,itcf_throw_knife, 0 , weight(3.5)|difficulty(0)|spd_rtng(102) | shoot_speed(25) | thrust_damage(16 ,  cut)|max_ammo(14)|weapon_length(0),imodbits_missile ],
 ["tutorial_saddle_horse", "Saddle Horse", [("saddle_horse",0)], itp_type_horse, 0, 0,abundance(90)|body_armor(3)|difficulty(0)|horse_speed(40)|horse_maneuver(38)|horse_charge(8),imodbits_horse_basic],
 ["tutorial_shield", "Kite Shield", [("shield_kite_a",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(150),imodbits_shield ],
 ["tutorial_staff_no_attack","Staff", [("wooden_staff",0)],itp_type_polearm|itp_offset_lance|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack,itc_parry_polearm|itcf_carry_sword_back,9, weight(3.5)|spd_rtng(120) | weapon_length(115)|swing_damage(0,blunt) | thrust_damage(0,blunt),imodbits_none],
 ["tutorial_staff","Staff", [("wooden_staff",0)],itp_type_polearm|itp_offset_lance|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack,itc_staff|itcf_carry_sword_back,9, weight(3.5)|spd_rtng(120) | weapon_length(115)|swing_damage(16,blunt) | thrust_damage(16,blunt),imodbits_none],
...
### boss item
["nordic_archer_helmet", "Nordic Leather Helmet", [("Helmet_A_vs2",0)], itp_merchandise| itp_type_head_armor    ,0, 40 , weight(1.25)|abundance(100)|head_armor(60)|body_armor(60)|leg_armor(60)|difficulty(0) ,imodbits_plate ],
### boss item
...
[(ti_on_weapon_attack, [
  ...
  (set_fixed_point_multiplier, 1000),
	(agent_get_player_id, ":player_no", ":user_agent"),
  (player_is_active, ":player_no"),
	(try_begin),
		(player_get_gold, ":player_gold", ":player_no"),
		(ge, ":player_gold", "$invasion_barricade_cost"), 
    (agent_get_position, pos1, ":user_agent"),
    (position_move_z, pos1, 75, 1),
		(position_move_y, pos1, 150),
    (position_rotate_x, pos1, 90),
    
    (try_begin),
      (call_script, "script_cf_spawn_barricade", pos1, 200),
        (val_sub, ":player_gold", "$invasion_barricade_cost"),
        (player_set_gold, ":player_no", ":player_gold", multi_max_gold_that_can_be_stored),
    (else_try),
      (assign, reg1, "$invasion_barricades_max_num"),
      (multiplayer_send_string_to_player, ":player_no", multiplayer_event_show_server_message,"@Max barricades limit reached! (limit = {reg1})" ),
    (try_end),
	(else_try),
    (store_sub, reg1, "$invasion_barricade_cost", ":player_gold"),
    (multiplayer_send_string_to_player, ":player_no", multiplayer_event_show_server_message,"@You need {reg1} more gold to place a barricade!" ),
	(try_end),
	])
	]],
...
23 , weight(0.75)|difficulty(0)|spd_rtng(108) | weapon_length(60)|swing_damage(60 , cut) | thrust_damage(60 ,  pierce),imodbits_sword ],
### boss item
...
## 28 days edit VV
["voulge_long",         "Voulge", [("two_handed_battle_long_axe_a",0)], itp_type_polearm|itp_merchandise| itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_staff,
...
[
  (ti_on_weapon_attack, [
    ...
    # (set_fixed_point_multiplier, 1000),
    # (position_rotate_z, pos1, 87),
    # (position_rotate_x, pos1, "$sweet_x_value"),
    # (position_rotate_y, pos1, "$sweet_y_value"),
    # (position_rotate_z, pos1, "$sweet_z_value"),
    
    
    # (add_missile,  ":agent_id", pos1, 55000, "itm_short_bow", 0, "itm_practice_arrows_2", 0),
    ...
    # (str_store_string, s1, "@HIT HIT HIT"),
...
22 , weight(2.25)|difficulty(0)|spd_rtng(47) | shoot_speed(50) | thrust_damage(60 ,  pierce)|max_ammo(1),imodbits_crossbow ],
...
["flintlock_pistol", "Flintlock Pistol", [("flintlock_pistol",0)], itp_type_pistol |itp_merchandise|itp_primary ,itcf_shoot_pistol|itcf_reload_pistol, 230 , weight(1.5)|difficulty(0)|spd_rtng(255) | shoot_speed(160) | thrust_damage(255 ,pierce)|max_ammo(5)|accuracy(100),imodbits_none,
 [(ti_on_weapon_attack, [
   (play_sound,"snd_pistol_shot"),
   (position_move_x, pos1,27),
   (position_move_y, pos1,36),
   ...
   (agent_set_ammo, ":agent_no", "itm_flintlock_pistol", 5),
...
240, weight(5)|spd_rtng(255) | swing_damage(255,cut)|weapon_length(255),imodbits_thrown ], 
...
["items_end", "Items End", [("shield_round_a",0)], itp_type_shield|itp_wooden_parry|itp_civilian, itcf_carry_bow_back,  118 , weight(2.5)|hit_points(99999)|body_armor(255)|spd_rtng(255)|weapon_length(255),0 ],
]
